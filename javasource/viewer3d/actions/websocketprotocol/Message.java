...
public final class Message extends Table {
  ...
  public String action() { int o = __offset(16); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer actionAsByteBuffer() { return __vector_as_bytebuffer(16, 1); }
  public ByteBuffer actionInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 16, 1); }
  public MessageContent content() { return content(new MessageContent()); }
  public MessageContent content(MessageContent obj) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public static void addAction(FlatBufferBuilder builder, int actionOffset) { builder.addOffset(6, actionOffset, 0); }
